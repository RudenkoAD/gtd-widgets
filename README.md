...
> _Плейсхолдеры — замените на реальные скриншоты с устройства._

| Сегодня | Входящие | Быстрый захват |
| --- | --- | --- |
| ![Виджет «Сегодня»](docs/screenshot-today.png) | ![Виджет «Входящие»](docs/screenshot-inbox.png) | ![Быстрый захват](docs/screenshot-capture.png) |
