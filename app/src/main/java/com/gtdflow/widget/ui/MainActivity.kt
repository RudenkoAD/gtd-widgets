...
private const val INSTRUCTIONS =
    "1. Выберите папку vault Obsidian (общая папка телефона, куда синкает Remotely Save).\n" +
        "2. Добавьте виджеты на домашний экран: «GTD · Сегодня» и «GTD · Входящие».\n" +
        "3. Для «Входящих» при добавлении выберите пространство (или «Общее»/«Все»).\n" +
        "4. Тап по заголовку виджета — обновить; тап по задаче «Сегодня» — открыть в Obsidian.\n" +
